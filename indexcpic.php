...
<head>
<title>Update Shop picture</title>
...
<div id="body">
    <br>
    <center><h3>Update your Shop Photo here</h3></center>
	<form action="uploadchangpic.php" method="post" enctype="multipart/form-data">
            <table id='formtable' cellspacing='20px'><tr><td>Enter your Username</td><td><input type="text" name="username" value='<?php echo $usrnam; ?>' id='usnenter' readonly='readonly'/></td></tr>
